...
std::vector<double> ALEXTrajectoryGenerator::getSetPoint(double time) {
...
***********************************************************************/
void ALEXTrajectoryGenerator::setTrajectoryParameter(time_tt step_duration, double step_height, double step_length, double hip_height_slack, double torso_forward_angle, double swing_ankle_down_angle,
...
void ALEXTrajectoryGenerator::setTrajectoryParameter(trajectory_parameters trajectoryParameter) {
    this->trajectoryParameter = trajectoryParameter;
}
void ALEXTrajectoryGenerator::setPilotParameter(double lowerleg_length, double upperleg_length, double ankle_height, double foot_length,
...
void ALEXTrajectoryGenerator::setPilotParameter(pilot_parameters pilotParameter) {
