...
{
    mark = mark + 1;
    robot->jointIncrement();
}
// void Toy::updateJoints(void){
//     // Update joint positions from OBJECT DICTIONARY
//         Should work in the say way as the youUpdate virtually increasing joint angles.
// }

// Robot interface methods ----------------------------------------------------------
void Toy::initRobot( Robot *rb ) {
