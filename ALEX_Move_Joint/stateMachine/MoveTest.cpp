...
// State Methods ----------------------------------------------------------
void Toy::posMotion::entry(void)
{
    //READ TIME OF MAIN
    OWNER->mark;
    printf("Positive Degree motion state Entered at Time %f\n", OWNER->mark);
}
void Toy::posMotion::during(Robot R) {
    R.printInfo();
}
void Toy::posMotion::exit(void)
{

    printf("Positive Motion motion state Exited at Time %f\n", OWNER->mark);
}
// State Two
